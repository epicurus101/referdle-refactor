...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function dimensionConform(){
        ...
        if (common.developerMode) {console.log(window.getComputedStyle(r).getPropertyValue("--custom"))}
        ...
        if (common.developerMode) {console.log('width is ', sqWidth)}


        let container = document.getElementById("board-container")
        if (common.developerMode) {console.log(`container height: ${container.offsetHeight}`)}
        if (common.developerMode) {console.log(`board height: ${board.boardDiv.offsetHeight}`)}
